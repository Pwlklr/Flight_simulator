...
const glm::vec3 FORWARD = +X_AXIS; // const forward vector
const glm::vec3 UP = +Y_AXIS;
const glm::vec3 RIGHT = +Z_AXIS;
const glm::vec3 BACKWARD = -X_AXIS;
const glm::vec3 DOWN = -Y_AXIS;
const glm::vec3 LEFT = -Z_AXIS;

// airfoil data, alpha (the angle of attack), lift coefficient, drag coefficient
const std::vector<glm::vec3> NACA_0012_data = {
    ...
    { -1.250f, -0.1345f, 0.00554f },
    { -1.000f, -0.1077f, 0.00548f },
    { -0.750f, -0.0810f, 0.00543f },
    { -0.500f, -0.0544f, 0.00539f },
    { -0.250f, -0.0277f, 0.00537f },
    { 0.000f, 0.0000f, 0.00536f },
    { 0.250f, 0.0277f, 0.00537f },
    { 0.500f, 0.0544f, 0.00539f },
    { 0.750f, 0.0810f, 0.00543f },
    { 1.000f, 0.1077f, 0.00548f },
    ...
    { 4.750f, 0.5213f, 0.00816f },
    { 5.000f, 0.5571f, 0.00847f },
    { 5.250f, 0.6268f, 0.00911f },
    { 5.500f, 0.6601f, 0.00942f },
    { 5.750f, 0.6939f, 0.00973f },
    { 6.000f, 0.7289f, 0.01003f },
    { 6.250f, 0.7634f, 0.01034f },
    { 6.500f, 0.7975f, 0.01069f },
    { 6.750f, 0.8268f, 0.01095f },
    { 7.000f, 0.8475f, 0.01124f },
    { 7.250f, 0.8687f, 0.01149f },
    { 7.500f, 0.8888f, 0.01187f },
    { 7.750f, 0.9104f, 0.01209f },
    { 8.000f, 0.9313f, 0.01240f },
    { 8.250f, 0.9517f, 0.01279f },
    { 8.500f, 0.9735f, 0.01307f },
    { 8.750f, 0.9948f, 0.01341f },
    { 9.000f, 1.0143f, 0.01395f },
    { 9.250f, 1.0368f, 0.01423f },
    { 9.500f, 1.0591f, 0.01456f },
    { 9.750f, 1.0807f, 0.01499f },
    { 10.000f, 1.1000f, 0.01566f },
    { 10.250f, 1.1228f, 0.01602f },
    { 10.500f, 1.1449f, 0.01645f },
    { 10.750f, 1.1666f, 0.01690f },
    { 11.000f, 1.1872f, 0.01745f },
    { 11.250f, 1.2032f, 0.01839f },
    { 11.500f, 1.2250f, 0.01881f },
    { 11.750f, 1.2455f, 0.01931f },
    { 12.000f, 1.2649f, 0.01988f },
    { 12.250f, 1.2834f, 0.02049f },
    { 12.500f, 1.3004f, 0.02117f },
    { 12.750f, 1.3132f, 0.02207f },
    { 13.000f, 1.3149f, 0.02343f },
    { 13.250f, 1.3281f, 0.02416f },
    { 13.500f, 1.3399f, 0.02502f },
    { 13.750f, 1.3502f, 0.02602f },
    { 14.000f, 1.3590f, 0.02718f },
    { 14.250f, 1.3669f, 0.02849f },
    { 14.500f, 1.3739f, 0.02997f },
    { 14.750f, 1.3802f, 0.03160f },
    { 15.000f, 1.3854f, 0.03348f },
    { 15.250f, 1.3879f, 0.03577f },
    { 15.500f, 1.3868f, 0.03865f },
    { 15.750f, 1.3806f, 0.04234f },
    { 16.000f, 1.3687f, 0.04704f },
    { 16.250f, 1.3519f, 0.05263f },
    { 16.500f, 1.3427f, 0.05745f },
    { 16.750f, 1.3322f, 0.06256f },
    { 17.000f, 1.3193f, 0.06814f },
    { 17.250f, 1.3031f, 0.07429f },
    { 17.500f, 1.2852f, 0.08088f },
    { 17.750f, 1.2659f, 0.08782f },
    { 18.000f, 1.2456f, 0.09505f },
    { 18.250f, 1.2284f, 0.10229f }
};
